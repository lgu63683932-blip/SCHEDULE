...
export const BusinessTripForm: React.FC = () => {
  ...
  const existing = id ? getDocument(id) as BusinessTripDoc | undefined : undefined
      ...
      <div className="max-w-3xl mx-auto px-6 py-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          <div className="px-8 py-5 border-b border-gray-100 bg-gray-50">
            ...
            <h1 className="text-xl font-bold text-gray-900">{existing ? '출장보고서 수정' : '출장보고서 작성'}</h1>
          </div>
          <div className="px-8 py-6 space-y-5">
            ...
            {[
              ...
              { label: '출장 내용', value: activities, onChange: setActivities, placeholder: '출장 중 수행한 업무를 입력하세요', rows: 5 },
              { label: '성과 및 결과', value: results, onChange: setResults, placeholder: '출장 성과 및 결과를 입력하세요', rows: 4 },
